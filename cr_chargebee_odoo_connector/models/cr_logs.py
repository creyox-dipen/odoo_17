...
class DataProcessingLog(models.Model):
    ...
    cr_configuration_id = fields.Many2one(
        "chargebee.configuration", string="Chargebee Config", required=True
    )
    ...
    cr_context = fields.Selection(
        ...
        string="Context",
        required=True,
        help="Identifies the context or page the log is related to.",
    )
