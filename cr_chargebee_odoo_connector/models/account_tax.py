...
class AccountTax(models.Model):
    ...
    chargebee_id = fields.Char(
        string="Chargebee Tax ID", help="ID of the tax in Chargebee"
    )
    ...
    def sync_taxes_from_chargebee(self):
        ...
        try:
                        ...
                        existing_tax.write(
                            {
                                ...
                                / 100,  # Assuming tax is a percentage
            ...
            raise UserError(
                _("Failed to sync taxes. Error: %s") % e.json_obj.get("message", str(e))
            )
