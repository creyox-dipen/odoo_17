...
class AccountMove(models.Model):
    ...
    def on_time_percent(self, invoices, rules):
        ...
        try:
            ...
            return self.verify_rules(rules, ontime_invoice_percentage) if self.verify_rules(rules, ontime_invoice_percentage) != None else 0
        except ZeroDivisionError:
            return 0
    ...
    def overdue_invoice_count(self, invoices, rules):
        ...
        for invoice in invoices:
            if invoice.payment_state == 'paid':
                ...
                if payment_date > invoice_due_date:
                    overdue_invoices += 1
        return self.verify_rules(rules, overdue_invoices) if self.verify_rules(rules, overdue_invoices) != None else 0
    ...
    def oldest_overdue_age(self, invoices, rules):
        ...
        return self.verify_rules(rules, days) if self.verify_rules(rules, days) != None else 0
    ...
    def order_frequency_monthly(self, invoices, rules):
        ...
        return self.verify_rules(rules, average_order_frequency) if self.verify_rules(rules, average_order_frequency) != None else 0
    ...
    def sales_volume_6mo(self, invoices, rules):
        ...
        return self.verify_rules(rules, six_months_sales) if self.verify_rules(rules, six_months_sales) != None else 0
    ...
    def outstanding_balance(self, invoices, rules):
        ...
        return self.verify_rules(rules, outstanding_balance) if self.verify_rules(rules, outstanding_balance) != None else 0
    ...
    def credit_note_ratio(self, invoices, rules):
        ...
        return self.verify_rules(rules, reversed_invoices_percentage) if self.verify_rules(rules, reversed_invoices_percentage) != None else 0
    ...
    def first_sale_age(self, invoices, rules):
        ...
        return self.verify_rules(rules, first_invoice_age) if self.verify_rules(rules, first_invoice_age) != None else 0
    ...
    def avg_order_value(self, invoices, rules):
        ...
        return self.verify_rules(rules, average_order_value) if self.verify_rules(rules, average_order_value) != None else 0
    ...
    def dispute_count(self, invoices, rules):
        ...
        for invoice in invoices:
            if invoice.payment_state == 'reversed':
                reversed_invoices += 1
        return self.verify_rules(rules, reversed_invoices) if self.verify_rules(rules, reversed_invoices) != None else 0
    ...
    def invoice_volume_monthly(self, invoices, rules):
        ...
        return self.verify_rules(rules, average_monthly_invoices) if self.verify_rules(rules, average_monthly_invoices) != None else 0